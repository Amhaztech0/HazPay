// Supabase Edge Function: Execute Scheduled Server Deletions
// This function runs on a cron schedule (every hour) to delete servers
// that have passed their deletion_scheduled_at time
